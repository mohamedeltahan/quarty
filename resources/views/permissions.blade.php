	...
	<div class="table-responsive">
        ...
        <thead>
            ...
            <select style="overflow: auto" class="permissions" data-attr="{{$user->id}}" name="permissions[]" id="" multiple="multiple" class="form-control">
               ...
               @if($user->account_type=="Admin")  <option @if($user->CanDo("permissions")) selected @endif value="permissions">permissions</option>     @endif               
            </select>
            </td>
          ...
          @if($i!=-1)
                       ...
                       @break;
                       @endif
                       <li class="page-item"><a class="page-link" href="{{route("permissions")}}?index={{$i+1}}">{{$i+1}}</a></li>
                       @endif            
         @endfor
