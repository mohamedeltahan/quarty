...
<style>
  ...
  <body>
    ...
    <input value="{{route("about.update","X")}}" id="aboutupdate" class="d-none">
                    ...
                    <div class="table-responsive">
                        <div class="table-wrapper">
                            <div class="table-title">
                                <div class="row">
                                    <div class="col-sm-4">
                                    <a href="{{route("about.index")}}" style="color: white">	<h2>Manage <b>About</b></h2> </a>
                                    </div>
                         ...
                         @endif
                            ...
                            <table class="table table-striped table-hover" style="text-align: center"  id="MainTable"> 
                                ...
                                <tbody>
                                    ...
                                    @foreach($about as $a)				
                                    <tr  data-id="{{$a->id}}">
                                        <td class="arabic_address">{{$a->arabic_address}}</td>
                                        <td class="english_address">{{$a->english_address}}</td>
                                        <td class="phones">{{$a->phones}}</td>
                                        <td class="facebook_link">{{$a->facebook_link}}</td>
                                        <td class="instagram_link">{{$a->instagram_link}}</td>
                                        <td class="twitter_link">{{$a->twitter_link}}</td>
                                        <td class="youtube_link">{{$a->youtube_link}}</td>
                                        <td class="linkedin_link">{{$a->linkedin_link}}</td>
                                        <td><i class="fa fa-pencil-square-o edit_row" href="#EditAboutModal"  data-toggle="modal" aria-hidden="true"></i></td>
          ...
          <!-- content-wrapper ends -->
                            ...
                            <div class="modal-body">					
                                    <div class="form-row">
                                         ...
                                         <div class="col-sm-6">
                                            ...
                                            <input required type="text" name="arabic_address" class="form-control">
                                         </div>
                                         ...
                                         <div class="col-sm-6">
                                          ...
                                          <input required type="text" name="english_address" class="form-control">
                                       </div>
                                    ...
                                    <div class="form-row">
                                      ...
                                      <div class="col-sm-6">
                                        ...
                                        <input required type="text" name="phones" class="form-control">
                                       </div>
                                       ...
                                       <div class="col-sm-6">
                                        ...
                                        <input required type="text" name="facebook_link" class="form-control">
                                     </div>
                                    </div>
                                    ...
                                    <div class="form-row">
                                      ...
                                      <div class="col-sm-6">
                                        ...
                                        <input required type="text" name="instagram_link" class="form-control">
                                     </div>
                                     ...
                                     <div class="col-sm-6">
                                      ...
                                      <input required type="text" name="twitter_link" class="form-control">
                                    </div>
                                    ...
                                    <div class="form-row">
                                      ...
                                      <div class="col-sm-6">
                                        ...
                                        <input required type="text" name="youtube_link" class="form-control">
                                      </div>
                                      ...
                                      <div class="col-sm-6">
                                        ...
                                        <input required type="text" name="linkedin_link" class="form-control">
                                      </div>
            ...
            <div id="EditAboutModal" class="modal fade">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form id="EditForm" method="post" data-link="{{route("about.update","")}}" action="" enctype="multipart/form-data">
                            @csrf
                            @method("put")
                            <div class="modal-header">						
            ...
            <!-- Delete Modal HTML -->
            <div id="DeleteAboutModal" class="modal fade DeleteModal">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form>
                            <div class="modal-header">						
    ...
    $(document).on("click",".edit_row",function(){
      ...
      var arabic_address=targeted_row.find(".arabic_address").text();
      var english_address=targeted_row.find(".english_address").text();
      var phones=targeted_row.find(".phones").text();
      var facebook_link=targeted_row.find(".facebook_link").text();
      var instagram_link=targeted_row.find(".instagram_link").text();
      var twitter_link=targeted_row.find(".twitter_link").text();
      var youtube_link=targeted_row.find(".youtube_link").text();
      var linkedin_link=targeted_row.find(".linkedin_link").text();

      $("#EditAboutModal").find("input[name=arabic_address]").val(arabic_address);
      $("#EditAboutModal").find("input[name=english_address]").val(english_address);
      $("#EditAboutModal").find("input[name=phones]").val(phones);
      $("#EditAboutModal").find("input[name=facebook_link]").val(facebook_link);
      $("#EditAboutModal").find("input[name=instagram_link]").val(instagram_link);
      $("#EditAboutModal").find("input[name=twitter_link]").val(twitter_link);

      $("#EditAboutModal").find("input[name=youtube_link]").val(youtube_link);
      $("#EditAboutModal").find("input[name=linkedin_link]").val(linkedin_link);
...
var img = $("#service_image");
var modalImg = $("#img01");
var captionText = $("#caption");
$(".service_image").click(function(){
