  ...
  <div class="qrt-menu">
    <div id="qrt-dynamic-menu" class="qrt-dynamic-menu">
      <nav>
        <ul>
          <li>
            <a class="qrt-mobile-fix" href="{{route("home")}}">Home</a>
          </li>
          <li>
            <a class="qrt-mobile-fix" href="about-us.html">About</a>
          </li>
          <li class="">
            <a class="qrt-mobile-fix" href="{{route("portfolio.index")}}">Portfolio</a>
          </li>
          <li>
            <a class="qrt-mobile-fix" href="{{route("contact")}}">Contact</a>
          </li>
          <li>
