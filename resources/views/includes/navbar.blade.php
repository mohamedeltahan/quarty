      ...
      <ul class="navbar-nav navbar-nav-right">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="messageDropdown">
            ...
            <div class="dropdown-divider"></div>
            <a class="dropdown-item preview-item" href="{{route("contactus.index")}}">
              <div class="preview-thumbnail">
                <img src="{{asset("assets/images/faces/face4.jpg")}}" alt="image" class="profile-pic">
              </div>
              <div class="preview-item-content d-flex align-items-start flex-column justify-content-center">
                <h6 class="preview-subject ellipsis mb-1 font-weight-normal">{ send you a message</h6>
                <p class="text-gray mb-0"> </p>
              </div>
            </a>
            <div class="dropdown-divider"></div>
            <div class="dropdown-divider"></div>
            <h6 class="p-3 mb-0 text-center"> <a href="{{route("contactus.index")}}">new messages </a></h6>
          </div>
        </li>

        <li class="nav-item dropdown">
          <a class="nav-link count-indicator dropdown-toggle d-none" id="notificationDropdown" href="#" data-toggle="dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="notificationDropdown">
            ...
            <h6 class="p-3 mb-0 text-center"><a href=""> all notifications</a></h6>
          </div>
        </li>
