...
<style>
  ...
  <body>
    ...
    <input value="{{route("services.update","X")}}" id="servicesupdate" class="d-none">
                            ...
                            <table class="table table-striped table-hover" style="text-align: center"  id="MainTable"> 
                                ...
                                <tbody>
                                    ...
                                    <tr  data-id="{{$service->id}}">
                                        <td class="arabic_title">{{$service->arabic_title}}</td>
                                        <td class="english_title">{{$service->english_title}}</td>
                                        
                                        <td class="arabic_description">{{$service->arabic_description}}</td>
                                        <td class="english_description">{{$service->english_description}}</td>
                                        <td class="image"><img class="service_image" src="{{asset("services-photos/".$service->photo_link)}}" style="max-width:70px"></td>
                            ...
                            <div class="modal-body">					
                                    <div class="form-row">
                                         ...
                                         <div class="col-sm-12">
                                            ...
                                            <input required type="text" name="arabic_title" class="form-control">
                                         </div>
                                    ...
                                    <div class="form-row">
                                      ...
                                      <div class="col-sm-12">
                                        ...
                                        <input required type="text" name="english_title" class="form-control">
                                       </div>
                                    </div>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-sm-12">
                                          ...
                                          <textarea required type="text" name="arabic_description" class="form-control"> </textarea>
                                         </div>
                                    </div>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-sm-12">
                                          ...
                                          <textarea required type="text" name="english_description" class="form-control"> </textarea>
                                         </div>
                                    </div>
    ...
    $(document).on("click",".edit_row",function(){
      ...
      var arabic_title=targeted_row.find(".arabic_title").text();
      var english_title=targeted_row.find(".english_title").text();


      var arabic_description=targeted_row.find(".arabic_description").text();
      var english_description=targeted_row.find(".english_description").text();
      $("#EditServiceModal").find("input[name=arabic_title]").val(arabic_title);
      $("#EditServiceModal").find("input[name=english_title]").val(english_title);
    
      $("#EditServiceModal").find("textarea[name=arabic_description]").text(arabic_description);
      $("#EditServiceModal").find("textarea[name=english_description]").text(english_description);
