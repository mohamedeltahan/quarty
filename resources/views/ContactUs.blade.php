              ...
              <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-danger card-img-holder text-white">
                  <div class="card-body">
                    ...
                    <h2 class="mb-5">{{count($contacts)}}</h2>
              ...
              <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-info card-img-holder text-white">
                  <div class="card-body">
                    ...
                    <h2 class="mb-5">{{$responded_count}}</h2>
                    <h6 class="card-text"></h6>
                  </div>
                </div>
              </div>
...
<div class="container-xl">
	<div class="table-responsive">
        ...
        @endif
			...
			<div class="clearfix">
				<div class="hint-text">Showing <b>{{sizeof($contacts)}}</b> out of <b>{{$count}}</b> entries</div>
				<ul class="pagination">
          ...
          @for($i=$index-2;$i<$no_of_pages;$i++)
             @if($i!=-1)
                          ...
                          @break;
                          @endif
                          <li class="page-item" ><a class="page-link" href="{{route("contactus.index")}}?index={{$i+1}}">{{$i+1}}</a></li>
             @endif            
            @endfor
